...
## System Diagram
![system_diagram](01_FPGA_Embedded_LED_Controller/system_diagram.jpg)
...
-Developed a C code, where the LED Controller parameters are accessed via the peripheral memory addresses.
